package com.pwr.students.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pwr.students.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pwr.students.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.pwr.students.domain.User.class.getName());
            createCache(cm, com.pwr.students.domain.Authority.class.getName());
            ...
            createCache(cm, com.pwr.students.domain.Answer.class.getName());
