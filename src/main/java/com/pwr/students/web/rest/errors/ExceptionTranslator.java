package com.pwr.students.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (ex instanceof com.pwr.students.service.EmailAlreadyUsedException) return new EmailAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof com.pwr.students.service.UsernameAlreadyUsedException) return new LoginAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof com.pwr.students.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
        if (
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.pwr.students");
    }
}
