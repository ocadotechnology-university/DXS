...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPASSIGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_GROUPASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPASSIGMENT actions', async () => {
      const expectedActions = [
        {
