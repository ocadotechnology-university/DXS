...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SURVEYASSIGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SURVEYASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SURVEYASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SURVEYASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SURVEYASSIGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SURVEYASSIGMENT actions', async () => {
      const expectedActions = [
        {
