...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './survey-target-groups.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SURVEYTARGETGROUPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SURVEYTARGETGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SURVEYTARGETGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SURVEYTARGETGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SURVEYTARGETGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SURVEYTARGETGROUPS actions', async () => {
      const expectedActions = [
        {
